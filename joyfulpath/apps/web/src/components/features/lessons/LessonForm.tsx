...
export function LessonForm({ classId, onSuccess, onCancel }: LessonFormProps) {
 ...
 className="w-full px-4 py-3 border border-outline rounded-xl bg-surface text-on-surface focus:ring-2 focus:ring-primary :ring-dark-primary outline-none min-h-32"
 required
 />
 </div>
 ...
 <div className="border-2 border-dashed border-outline rounded-xl p-6 text-center cursor-pointer hover:bg-surface-container-low :bg-dark-surface-container-low transition-colors">
 <input
 type="file"
