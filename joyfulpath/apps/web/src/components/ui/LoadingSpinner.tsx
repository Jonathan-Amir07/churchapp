...
export function LoadingSpinner({ size = 'md', className }: LoadingSpinnerProps) {
  ...
  return (
    <div className={clsx('animate-spin', sizeClasses[size], className)}>
      <svg
        className="w-full h-full text-primary dark:text-dark-primary"
...
export function PageLoadingState() {
  return (
    <div className="flex items-center justify-center min-h-screen bg-surface dark:bg-dark-surface">
