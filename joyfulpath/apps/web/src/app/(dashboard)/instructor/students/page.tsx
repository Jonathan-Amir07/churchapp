  ...
  return (
    <PageTransition className="space-y-6 pb-20 md:pb-0">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl md:text-4xl font-extrabold text-primary font-display-lg-mobile md:font-display-lg">المخدومين</h1>
          <p className="font-body-md text-on-surface-variant mt-2 text-lg">اختر فصلاً لعرض وإدارة بيانات مخدوميك.</p>
        </div>
      </div>
            ...
            stats.classes?.map((c: any) => (
              ...
              >
                ...
                <div className="flex justify-between text-sm text-on-surface-variant mt-4 pt-4 border-t border-outline-variant/50">
                  <span className="flex items-center gap-1 font-bold">{c._count?.members || 0} مخدوم</span>
                  <span className="flex items-center gap-1 text-primary font-bold">عرض الطلاب <span className="material-symbols-outlined text-[16px]">arrow_forward</span></span>
                </div>
              </Link>
            ))
          ) : (
