// ============================================
// newsl w nwasl ll sama Constants
// ============================================
...
export const NAV_ITEMS = {
  instructor: [
    ...
    { key: 'classes',     icon: 'school',              href: '/instructor/classes' },
    { key: 'students',    icon: 'groups',              href: '/instructor/students' },
    { key: 'prayers',     icon: 'volunteer_activism',  href: '/instructor/prayer-requests' },
    { key: 'analytics',   icon: 'analytics',           href: '/instructor/analytics' },
    { key: 'store',       icon: 'store',               href: '/instructor/store' },
  ],
  priest: [
    { key: 'dashboard',   icon: 'dashboard',           href: '/priest/dashboard' },
    { key: 'families',    icon: 'family_restroom',     href: '/priest/families' },
    { key: 'students',    icon: 'groups',              href: '/priest/students' },
    { key: 'attendance',  icon: 'event_available',     href: '/priest/attendance' },
