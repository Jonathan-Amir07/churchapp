...
export default function AdminAnalytics() {
 ...
 { label: isAr ? 'إجمالي الطلاب' : 'Total Students', value: String(stats.totalStudents), trend: '+5', icon: 'groups', iconBg: 'bg-purple-50 text-purple-500 ' },
 { label: tAnalytics('totalPointsRedeemed'), value: stats.totalPointsRedeemed.toLocaleString(), trend: '+320', icon: 'redeem', iconBg: 'bg-orange-50 text-orange-500 ' },
 ]?.map((stat, i) => (
