          ...
          <CardContent className="p-6 pt-0 space-y-4">
            <div className="flex items-center justify-between p-4 bg-surface-container rounded-xl border border-outline-variant/60">
              ...
              <input
                ...
                className="w-10 h-6 bg-surface-container-high rounded-full appearance-none relative checked:bg-primary before:w-4 before:h-4 before:rounded-full before:bg-outline before:absolute before:top-1 before:start-1 checked:before:start-5 before:transition-all before:duration-200 cursor-pointer"
              />
            </div>
