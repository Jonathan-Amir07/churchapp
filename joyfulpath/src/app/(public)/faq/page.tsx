...
const faqs = [
  ...
  { q: 'Who can use the platform?', qAr: 'من يمكنه استخدام المنصة؟', a: 'Students, parents, instructors (servants), and church administrators can all create accounts and use the platform with role-specific features.', aAr: 'يمكن للطلاب وأولياء الأمور والخدام (المعلمين) ومسؤولي الكنيسة إنشاء حسابات واستخدام المنصة بمميزات مخصصة لكل دور.' },
