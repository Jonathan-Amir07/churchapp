...
export function LessonCard({ lesson, onUpdate }: LessonCardProps) {
 ...
 archived: 'bg-error/10 text-error border-error',
 };

 return (
 <Card className="p-4 hover:shadow-lg transition-shadow duration-200 bg-surface-container-lowest h-full flex flex-col">
 <div className="flex items-start justify-between mb-3">
 <h3 className="text-lg font-bold text-on-surface line-clamp-2 flex-1">
 {lesson.title}
 </h3>
 <span
 ...
 <span className="text-xs bg-tertiary/10 text-tertiary px-2 py-1 rounded-full font-medium">
 ...
 disabled={loading}
 className="p-2 hover:bg-error/10 :bg-dark-error/10 text-error rounded-lg transition-colors"
 title="Delete lesson"
 >
