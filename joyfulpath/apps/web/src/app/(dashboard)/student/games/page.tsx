...
export default function StudentGames() {
 ...
 <span className="text-xs font-black uppercase text-purple-700 ">Clues:</span>
 ...
 <p className="text-sm font-semibold text-on-surface-variant leading-relaxed text-end border-t border-outline-variant/30 pt-2.5" dir="rtl">
 {verse.textAr}
 </p>
 </div>
